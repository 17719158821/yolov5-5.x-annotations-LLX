...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home_data/teacher01/llx/yolov5-5.x-annotations-main/runs/train/exp23/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/home_data/teacher01/llx/yolov5-5.x-annotations-main/runs/test/GUO ZI YUE', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--project', default='runs/detect/GUO ZI YUE', help='save results to project/name')
